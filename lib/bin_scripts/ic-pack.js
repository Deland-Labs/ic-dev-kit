...
import { get_dfx_json, get_dfx_package_json, get_wasm_path } from "../src/dfxJson";
...
const build_all = async (build_context) => {
...
const check = async (build_context) => {
...
const create = async (build_context) => {
    const out_dfx_json = {
        "defaults": {
            "build": {
                "args": "",
...
const create_zip = async (build_context) => {
