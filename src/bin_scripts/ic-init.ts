...
export const execute_task_init_dev_kit = () => {
    ...
    fs.writeFileSync(IC_DEV_KIT_CONFIGURATION_FILE_NAME, JSON.stringify(config, null, 4));
    fs.writeFileSync(DEFAULT_DFX_PACKAGE_JSON_FILENAME, JSON.stringify(DEFAULT_DFX_PACKAGE_JSON, null, 4));
}