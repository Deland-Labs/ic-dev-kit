...
export const parseICLedgerInit = (input: ICLedgerInitParameter): ArrayBuffer => {
  ...
  const args = {
    ...
    transaction_window: p.transaction_window
      ? [{ secs: BigInt(p.transaction_window.secs), nanos: p.transaction_window.nanos }]
      : [],
      ...
      ? [
          {
            ...
            max_message_size_bytes: p.archive_options.max_message_size_bytes
              ...
              : [],
            node_max_memory_size_bytes: p.archive_options.node_max_memory_size_bytes
      ...
      ? [
          {
            ...
            max_message_size_bytes: input.archive_option.max_message_size_bytes
              ...
              : [],
            cycles_for_archive_creation: input.archive_option.cycles_for_archive_creation
              ? [BigInt(input.archive_option.cycles_for_archive_creation)]
              : [],
            node_max_memory_size_bytes: input.archive_option.node_max_memory_size_bytes
