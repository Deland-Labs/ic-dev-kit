...
export const principalToAccountIDInBytes = (principal: Principal, subAccount?: Uint8Array): Uint8Array => {
...
export const principalToAccountID = (principal: Principal, subAccount?: Uint8Array): string => {
...
export const runBatchJobs = async (func_groups: Array<Array<() => Promise<void>>>, sleep_after_done?: number) => {
  // recode time of cost
